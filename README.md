...
[`explore_hypotheses.py`](explore_hypotheses.py) is a scratch script for trying
mathematical conjectures on data generated by this library (not part of the
test suite). Run it with:

```bash
python explore_hypotheses.py
```
